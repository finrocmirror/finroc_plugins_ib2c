...
{
  //@todo: inhibition??
  this->iota = this->activity.GetDoubleRaw() * this->stimulation.GetDoubleRaw() * (1. - this->CalculateInhibition(this->inhibitions));
  ...
  this->CalculateTransferFunction(this->iota);
